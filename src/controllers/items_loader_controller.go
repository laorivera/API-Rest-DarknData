...
func CreateItemArmor(itemfile string) models.Item_Armor {
	var item models.Item_Armor // item to create
	readJSON(itemfile, &item)
	return item
}

func CreateItemWeapon(itemfile string) models.Item_Weapon {
	var item models.Item_Weapon // item to create
	readJSON(itemfile, &item)
	return item
}

func CreateItemAccessory(itemfile string) models.Item_Accessory {
	var item models.Item_Accessory // item to create
	readJSON(itemfile, &item)
	return item
}

var item = middleware.Item{
...
var Items = middleware.List_Items{
